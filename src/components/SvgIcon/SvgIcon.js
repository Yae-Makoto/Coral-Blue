...
export function SvgBackward() {
    return <Backward />
};

export function SvgForward() {
    return <Forward />
};
...
export function SvgBook() {
    return <Book />
};

export function SvgMedal() {
    return <Medal />
};

export function SvgPullDown() {
    return <PullDown />
};
